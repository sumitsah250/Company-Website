        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <ScrollReveal direction="up" distance={30}>
              <div>
                <span className="text-sm font-medium text-primary uppercase tracking-[0.15em] mb-6 block">Products</span>
            ...
            {products.map((product, i) => (
              <ScrollReveal key={product.name} direction="up" distance={25} delay={i * 0.1}>
                <TiltCard intensity={6}>
                  <div className="group relative p-8 sm:p-10 rounded-2xl bg-background border border-white/[0.06] hover:border-primary/25 transition-all duration-700 h-full glow-subtle hover:glow-primary">
                    ...
                    <p className="text-primary text-sm font-medium mb-4">{product.tagline}</p>
                    ...
                    <button
                      className={`inline-flex items-center gap-2 px-6 py-3 rounded-xl text-sm font-semibold transition-all duration-300 ${
                        product.status === "Available"
                          ? "bg-white text-background hover:shadow-lg hover:shadow-primary/15 hover:scale-[1.02]"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <ScrollReveal direction="scale" distance={0}>
            <div className="max-w-3xl mx-auto text-center">
              ...
              <Link href="/contact" className="group relative inline-flex items-center gap-2 px-8 py-4 rounded-xl bg-white text-background font-semibold overflow-hidden transition-all duration-300 hover:shadow-xl hover:shadow-primary/15 hover:scale-[1.02]">
