        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <ScrollReveal direction="up" distance={30}>
              <div>
                <span className="text-sm font-medium text-primary uppercase tracking-[0.15em] mb-6 block">Services</span>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <ScrollReveal direction="up" distance={20}>
              <div className="text-center mb-20">
                <span className="text-sm font-medium text-primary uppercase tracking-[0.15em] mb-4 block">Capabilities</span>
              ...
              {services.map((service, i) => (
                <ScrollReveal key={service.title} direction="up" distance={25} delay={i * 0.06}>
                  <TiltCard intensity={6}>
                    <div className="p-8 sm:p-10 rounded-2xl bg-surface-elevated border border-white/[0.06] h-full glow-subtle hover:glow-primary transition-all duration-700">
