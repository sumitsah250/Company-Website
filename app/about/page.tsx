  ...
  return (
    <main className="min-h-screen relative">
      ...
      <section className="py-24 sm:py-32 bg-surface border-y border-border/30 relative overflow-hidden">
        <div className="absolute bottom-0 left-1/4 w-[300px] h-[300px] bg-secondary/5 rounded-full blur-[120px]" />
        ...
        <section className="py-24 sm:py-32 relative">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <span className="text-sm font-medium text-primary uppercase tracking-wider mb-4 block">Our Principles</span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {values.map((value) => (
                <TiltCard key={value.title} intensity={8}>
                  <div className="group p-8 rounded-2xl bg-surface-elevated border border-border/40 hover:border-primary/30 transition-all duration-500 h-full glow-subtle hover:glow-primary">
                    <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-primary/15 to-secondary/15 flex items-center justify-center mb-6 group-hover:from-primary/25 group-hover:to-secondary/25 transition-all duration-500">
      ...
      <section className="py-24 sm:py-32 bg-surface border-y border-border/30 relative">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <span className="text-sm font-medium text-primary uppercase tracking-wider mb-4 block">The People</span>
          ...
          <Link 
            href="/team" 
            className="group inline-flex items-center gap-2 text-primary hover:text-secondary transition-colors"
          >
            View the Full Team
      ...
      <section className="py-24 sm:py-32 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center mb-16">
            <span className="text-sm font-medium text-primary uppercase tracking-wider mb-4 block">Methodology</span>
            ...
            {[
              ...
              <TiltCard key={item.title} intensity={6}>
                <div className="p-8 rounded-2xl bg-surface-elevated border border-border/40 text-center h-full glow-subtle">
                  <div className="w-12 h-12 mx-auto rounded-xl bg-gradient-to-br from-primary/15 to-secondary/15 flex items-center justify-center mb-4 text-primary font-bold text-lg">
